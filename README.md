...
| **[BlackSharp.IO.HID](https://github.com/Blacktempel/BlackSharp/tree/master/BlackSharp.IO.HID)** <br/> Provides USB HID transport with device discovery and cancellable worker-based I/O. <br/> This is cross-platform. | .NET Framework 4.7.2 & 4.8.1 <br/> .NET Standard 2.0 <br/> .NET 8, 9 and 10 | [![Nuget](https://img.shields.io/nuget/v/BlackSharp.IO.HID?label=NuGet)](https://www.nuget.org/packages/BlackSharp.IO.HID/) <br/> [![Nuget](https://img.shields.io/nuget/dt/BlackSharp.IO.HID?label=NuGet-Downloads)](https://www.nuget.org/packages/BlackSharp.IO.HID/) |
| **[BlackSharp.IO.Ports](https://github.com/Blacktempel/BlackSharp/tree/master/BlackSharp.IO.Ports)** <br/> Provides a System.IO.Ports-like API for serial communication, implemented with native platform backends and timeout-safe close handling. <br/> This is cross-platform. | .NET Framework 4.7.2 & 4.8.1 <br/> .NET Standard 2.0 <br/> .NET 8, 9 and 10 | [![Nuget](https://img.shields.io/nuget/v/BlackSharp.IO.Ports?label=NuGet)](https://www.nuget.org/packages/BlackSharp.IO.Ports/) <br/> [![Nuget](https://img.shields.io/nuget/dt/BlackSharp.IO.Ports?label=NuGet-Downloads)](https://www.nuget.org/packages/BlackSharp.IO.Ports/) |
