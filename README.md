...
| **[BlackSharp.IO.Ports](https://github.com/Blacktempel/BlackSharp/tree/master/BlackSharp.IO.Ports)** <br/> Provides native cross-platform serial communication and raw USB access. <br/> This is cross-platform. | .NET Framework 4.7.2 & 4.8.1 <br/> .NET Standard 2.0 <br/> .NET 8, 9 and 10 | [![Nuget](https://img.shields.io/nuget/v/BlackSharp.IO.Ports?label=NuGet)](https://www.nuget.org/packages/BlackSharp.IO.Ports/) <br/> [![Nuget](https://img.shields.io/nuget/dt/BlackSharp.IO.Ports?label=NuGet-Downloads)](https://www.nuget.org/packages/BlackSharp.IO.Ports/) |
